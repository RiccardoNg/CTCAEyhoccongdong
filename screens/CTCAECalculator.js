...
export class CTCAECalculator extends Component {
  constructor(props) {
    super(props);
    this.state = { 
		username: 'Nhat',
		...
		<View style={styles.content}>
        	...
        	<View style={styles.body}>
				...
				<View style={styles.footer} >
					...
					<TouchableOpacity style={styles.buttonRow} onPress={() => this.props.navigation.push('MyhealthnoteScreen')}>
						<Svg width={0.89*fullWidth} height={0.153*fullWidth} viewBox='0 0 320 55'>
						<Defs>
							<LinearGradient id='gradient2' x1='0' y1='0' x2='100%' y2='100%'>
								<Stop offset='0' stopColor="#71D6E6" stopOpacity="1" />
...
export default CTCAECalculator;
