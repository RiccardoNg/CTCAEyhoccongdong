        	...
        	<View style={styles.body}>
					<View style={styles.result} >
						<View style={styles.resultHeader}>
							...
							Doctor Avatar-Name-Honorpoint-Tips: {this.state.result}
							</Text>
						</View>
						<View style={styles.resultHeader}>
							<Text style={styles.resultTitle}>
							Search bar: {this.state.result}
							</Text>
						</View>
						<View style={styles.resultHeader}>
							<Text style={styles.resultTitle}>
							My patient list: {this.state.result}
							</Text>
						</View>
						<View style={styles.resultHeader}>
							<Text style={styles.resultTitle}>
							Patient result/time: {this.state.result}
							</Text>
						</View>
